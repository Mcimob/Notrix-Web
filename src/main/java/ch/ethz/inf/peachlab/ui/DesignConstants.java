...
public final class DesignConstants {
    ...
    public static final String CLR_LIGHT = "var(--clr-light)";
    public static final String CLR_REGULAR = "var(--clr-regular)";
    public static final String CLR_DARK = "var(--clr-dark)";
}
